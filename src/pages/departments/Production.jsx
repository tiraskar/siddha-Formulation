        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Production Department</h1>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 shadow-md p-6 text-center">
                ...
                <p className="text-green-600 text-sm mb-6">Director – Production</p>
              ...
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  All manufacturing activities are conducted in strict compliance with the Department of Drug Administration (DDA), Ministry of Health and Population, Government of Nepal. Our facilities adhere to WHO-GMP standards, ensuring the highest levels of safety, consistency, and efficacy in every formulation.
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-md">
            ...
            <p className="mt-2 text-gray-600 text-sm">
              Multi-level quality checks ensuring purity, safety, and efficacy of
              every formulation.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            ...
            <p className="mt-2 text-gray-600 text-sm">
              Responsible sourcing and eco-conscious practices to protect natural
              resources.
            </p>
          </div>
        </div>
