...
// ----------------------------------------------------------------------
// 2. NEW PRODUCT DETAILS COMPONENT (Custom Tabs) - UPDATED
// ----------------------------------------------------------------------
...
const ProductDetails = ({ product }) => {
  ...
  return (
    <div className="max-w-[1100px] mx-auto w-full px-6 md:px-0 mt-8">
      ...
      {/* --- Content Area (Removed inner H3 heading) --- */}
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-100">
        {/* Removed: <h3 className="text-lg font-bold text-gray-900 mb-4 uppercase">
          {contentData[activeTabIndex].title}
        </h3> */}
        {contentData[activeTabIndex].content}
      </div>
    </div>
...
// ----------------------------------------------------------------------
// 5. MAIN ProductDetail COMPONENT (Unchanged)
// ----------------------------------------------------------------------
